...
const Signup = () => {
  ...
  const postDetails = (pics) => {
    ...
    if (pics.type === "image/jpeg" || pics.type === "image/png") {
      ...
      data.append("upload_preset", "connect-chatter");
      data.append("cloud_name", "shankarftw");
      fetch("https://api.cloudinary.com/v1_1/shankarftw/image/upload", {
        method: "post",
        body: data,
      })
        .then((res) => res.json())
  ...
  return (
    <VStack spacing="5px">
      ...
      <FormControl id="set_password" isRequired>
